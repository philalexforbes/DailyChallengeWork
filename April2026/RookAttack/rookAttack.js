...
const rookAttack = (rook1, rook2) => {
    const regex = /[A-Za-z]|\d/gm;
    let rook1MoveBreakdown = rook1.match(regex);
    let rook2MoveBreakdown = rook2.match(regex);

    if(rook1MoveBreakdown[0] === rook2MoveBreakdown[0] || rook1MoveBreakdown[1] === rook2MoveBreakdown[1]) {
        return true;
    }
    else {
        return false;
